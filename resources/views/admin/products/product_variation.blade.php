...
@if(isset($variation))
  ...
  <div class="content-wrapper" id="variations" @if(count($variation) == 0)  style="display:none;" @endif>
                          ...
                          <table width="100%" class="service_table frm-elm" id="service_table-{{$key1}}">
                              <tr>
                                ...
                                <td width="25%" class="px-2 py-1">
                                  ...
                                  <select name="variation[{{$index}}][{{$index1}}][attr_id]" data-name="attr_id" class="form-control attribzutes input attr_name" id="attr_id-{{$index}}-{{$index1}}">
