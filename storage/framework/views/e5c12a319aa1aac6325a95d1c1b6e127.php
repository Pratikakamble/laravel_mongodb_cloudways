                          ...
                          <table width="100%" class="service_table frm-elm" id="service_table-<?php echo e($key1); ?>">
                              <tr>
                                ...
                                <td width="25%" class="px-2 py-1">
                                  ...
                                  <select name="variation[<?php echo e($index); ?>][<?php echo e($index1); ?>][attr_id]" data-name="attr_id" class="form-control attributes input attr_name" id="attr_id-<?php echo e($index); ?>-<?php echo e($index1); ?>">
...
<?php endif; ?>
 ...
 <div class="content-wrapper" id="display_on_switch" style="display:none;">
  ...
  </div><?php /**PATH D:\Laravel_Mongodb\resources\views/admin/products/product_variation.blade.php ENDPATH**/ ?>